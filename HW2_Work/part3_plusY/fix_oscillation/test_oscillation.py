#!/usr/bin/env python3
"""Evaluate a trained Part 3+Y anti-oscillation PPO policy."""
...
from drone_env_oscillation import DroneCurriculumEnv, normalize_variant


FIX_DIR = Path(__file__).resolve().parent
LOG_DIR = FIX_DIR / "logs"
DEFAULT_MODEL = FIX_DIR / "models" / "latest" / "ppo_drone.zip"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Part 3+Y anti-oscillation drone PPO.")
