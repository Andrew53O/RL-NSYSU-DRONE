#!/usr/bin/env python3
"""Evaluate a trained Part 4 PPO policy."""
...
DEFAULT_MODEL = PART4_DIR / "models" / "latest" / "ppo_drone.zip"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Part 4 drone PPO.")
